      ...
      >
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl overflow-hidden flex min-h-[600px] relative">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.5 }}
            className="flex-1 p-12 flex flex-col justify-center relative z-10 order-1"
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                {/* name field removed — sign-up disabled */}
          ...
          <motion.div
            ...
            className="flex-1 bg-[#012169] p-12 flex flex-col justify-center items-center text-white relative overflow-hidden"
          >
              {/* Decorative circles */}
              ...
              >
                ...
                {/* sign-up action removed — only sign-in available */}
              </motion.div>
            </motion.div>
        </div>
      </motion.div>
