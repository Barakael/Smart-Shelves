  ...
  return (
    <>
      <motion.aside
        ...
        className="w-72 bg-white dark:bg-gray-950 border-r border-primary-300/30 dark:border-primary-800/30 shadow-xl flex flex-col relative z-20"
      >
        ...
        {/* User Info Section */}
        <div className="px-6 py-3 bg-white dark:bg-gray-950 border-b border-primary-300/30 dark:border-primary-800/30">
          <div className="flex items-center space-x-3 text-gray-700 dark:text-gray-300">
            <div className="w-9 h-9 rounded-full bg-[#012169] flex items-center justify-center shadow-md">
        ...
        {/* Navigation Menu */}
        <nav className="flex-1 px-4 py-4 space-y-2 bg-white dark:bg-gray-950 ">
          {menuItems.map((item) => {
